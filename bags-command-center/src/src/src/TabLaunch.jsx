          ...
          <div key={s} style={{ display: 'flex', alignItems: 'center', flex: i < STEPS.length - 1 ? 1 : 0 }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
              <div style={{
                ...
                background: step === i ? '#f97316' : step > i ? 'rgba(16,185,129,0.2)' : 'rgba(255,255,255,0.08)',
                color: step > i ? '#10b981' : step === i ? '#fff' : '#4b5563',
                border: step > i ? '1px solid rgba(16,185,129,0.4)' : 'none',
              }}>{step > i ? '✓' : i + 1}</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ padding: 20, borderRadius: 12, background: 'rgba(249,115,22,0.08)', border: '1px solid rgba(249,115,22,0.2)' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: '#475569', marginTop: 4 }}>
                <span>0.1% min</span><span>5% max</span>
              </div>
            </div>
        ...
        {step === 3 && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 8 }}>
              ...
              <a href={`https://bags.fm/create?name=${encodeURIComponent(form.name)}&ticker=${encodeURIComponent(form.ticker)}`} target="_blank" rel="noopener noreferrer"
                style={{ flex: 2, padding: '12px', borderRadius: 10, background: 'linear-gradient(135deg,#f97316,#ef4444)', color: '#fff', fontWeight: 800, fontSize: 15, textDecoration: 'none', textAlign: 'center' }}>
                🚀 Launch on Bags.fm
              </a>
            </div>
          </div>
